...
function SearchBar() {
  ...
  return (
    <div className='flex items-center xl:sticky xl:top-4 z-40 justify-between mb-6 xl:gap-20 2xl:gap-28'>
        ...
        <div className='flex gap-4 items-center justify-between sm:gap-6'>
           <div className={`${style.switch_button} flex  cursor-pointer bg-pureWhite relative items-center gap-2 z-10 rounded-full border px-1 py-1`}>
               ...
               <img className={`${isDarkActive && style.active} z-40 w-5 relative`} src={moonIcon} alt="" />
               <img className={`${!isDarkActive && style.active} z-10 w-5 relative`} src={sunIcon} alt="" />
           </div>
